...
function ArchivedJars() {//Stores state of userJSON returned from the GET Request
    ...
    if(UserTest.my_Jars !== undefined) {
        ...
        return(
          <Grid
                     ...
                     display="flex"
                     justify="center">
          {myJars.filter(jar => jar.closed === false).map( filteredJar => {
              return(
